...
public final class DuckLakeQueryRunner
{
    ...
    // Schema matches DuckDB 1.5 ducklake extension output
    ...
    public static DistributedQueryRunner createQueryRunner()
            throws Exception
    {
        return createQueryRunner(Files.createTempDirectory("ducklake-test"));
    }

    public static DistributedQueryRunner createQueryRunner(Path tempDir)
            throws Exception
    {
